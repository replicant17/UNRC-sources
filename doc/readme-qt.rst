UniversalRoyalCoin-qt: Qt4 GUI for UniversalRoyalCoin
===============================
...
Alternatively, install Qt Creator and open the `UniversalRoyalCoin-qt.pro` file.

An executable named `UniversalRoyalCoin-qt` will be built.
...
A warning for people using the *static binary* version of UniversalRoyalCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of UniversalRoyalCoin is linked against libdb5.3.
...
installed causes UniversalRoyalCoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
