...
static const uint256 hashGenesisBlock("0x00000509126f8144bcb653731a749bcb0035a1dbe7986be86d26b989936e35d4");
static const uint256 hashGenesisBlockTestNet("0x000c763e402f2436da9ed36c7286f62c3f6e5dbafce9ff289bd43d7459327eb");

inline int64_t PastDrift(int64_t nTime)   { return nTime - ((4 * 3 + 10) * 60); } // up to this from the past
...
public:
    ...
    {
        // Protocol switch to support p2pool at UniversalRoyalCoin block #0
        ...
        // Before UniversalRoyalCoin block #0 - get from pregenerated table
