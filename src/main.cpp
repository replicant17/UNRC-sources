...
const string strMessageMagic = "UniversalRoyalCoin Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("UniversalRoyalCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in UniversalRoyalCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // UniversalRoyalCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "UniversalRoyalCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "UNRC Genesis";
        CTransaction txNew;
        txNew.nTime = 1494257265;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1494257265;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 443205; // !fTestNet ? 1575379 : 46534;
		
        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0xcef4f00781301f92457fa9078b7bca4633379510eded1186d7fc818c4f1fb30e"));
...
unsigned char pchMessageStart[4] = { 0xb5, 0xf5, 0xe5, 0xb6 };
