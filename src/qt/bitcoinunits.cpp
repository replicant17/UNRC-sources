...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("UNRC");
    case mBTC: return QString("mUNRC");
    case uBTC: return QString::fromUtf8("μUNRC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("UniversalRoyalCoins"));
    case mBTC: return QString(QObject::tr("Milli-UniversalRoyalCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-UniversalRoyalCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
