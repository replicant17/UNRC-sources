...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("UniversalRoyalCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("UniversalRoyalCoin-net");
...
static const char *strDNSSeed[][2] = {
    {"seed1.unrc.eu", "217.61.21.132"},
	{"seed2.unrc.eu", "seed2.unrc.eu"},
	{"seed3.unrc.eu", "seed3.unrc.eu"},
	{"seed4.unrc.eu", "seed4.unrc.eu"},
    {"seed5.unrc.eu", "seed5.unrc.eu"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("UniversalRoyalCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("UniversalRoyalCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("UniversalRoyalCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("UniversalRoyalCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. UniversalRoyalCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("UniversalRoyalCoin-start");
